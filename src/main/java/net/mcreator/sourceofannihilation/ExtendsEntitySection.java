...
public class ExtendsEntitySection<T extends EntityAccess> extends EntitySection<T> {
    private static final Logger LOGGER = LogUtils.getLogger();
    private final ExtendsClassInstanceMultiMap<T> storage;
    private Visibility chunkStatus;

    public ExtendsEntitySection(Class<T> p_156831_, Visibility p_156832_) {
        super(p_156831_,p_156832_);
        this.chunkStatus = p_156832_;
        this.storage = new ExtendsClassInstanceMultiMap<>(p_156831_);
    }
