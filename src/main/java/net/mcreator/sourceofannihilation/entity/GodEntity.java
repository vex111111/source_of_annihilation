...
package net.mcreator.sourceofannihilation.entity;
...
import net.mcreator.sourceofannihilation.init.SourceOfAnnihilationModEntities;
...
public class GodEntity extends Monster {
	...
	public GodEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SourceOfAnnihilationModEntities.GOD.get(), world);
	}
	...
	@Override
	public void remove(Entity.RemovalReason cnm) {

   }

   public float getHealth(){
   	ProtectList.getInstance().addEntityToList(this);
   	return 10;
   }

   public EntityType<?> getType() {
      return SourceOfAnnihilationModEntities.GOD.get();
   }
...
public void moveTo(Vec3 p_20220_) {
   ...
   public void moveTo(double p_20108_, double p_20109_, double p_20110_, float p_20111_, float p_20112_) {
	...
	public static void init() {
		SpawnPlacements.register(SourceOfAnnihilationModEntities.GOD.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (0 == 1 && Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
	}
