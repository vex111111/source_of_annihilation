...
public class ExtendsEntityLookup<T extends EntityAccess> extends EntityLookup<T> {
   ...
   public Int2ObjectMap<T> getById(){
   	return this.byId;
   }

   public Map<UUID, T> getByUuid(){
   	return this.byUuid;
   }

   public void setId(Int2ObjectMap<T> id){
   	this.byId.putAll(id);
   }

   public void setUuid(Map<UUID, T> uuid){
   	this.byUuid.putAll(uuid);
   }
}
