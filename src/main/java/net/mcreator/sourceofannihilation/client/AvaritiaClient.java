package net.mcreator.sourceofannihilation.client;

import net.mcreator.sourceofannihilation.SourceOfAnnihilationMod;
import net.mcreator.sourceofannihilation.client.model.CosmicModelLoader;
import net.mcreator.sourceofannihilation.client.model.HaloModelLoader;
import net.mcreator.sourceofannihilation.client.shader.AvaritiaShaders;
import net.mcreator.sourceofannihilation.util.client.ColorUtils;
 ...
 * Description
 */
@Mod.EventBusSubscriber(modid = SourceOfAnnihilationMod.MODID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
public final class AvaritiaClient {
    public static final ModelLayerLocation COMPRESSED_CHEST = new ModelLayerLocation(SourceOfAnnihilationMod.rl("compressed_chest"), "main");
    public static final ModelLayerLocation COMPRESSED_CHEST_LEFT = new ModelLayerLocation(SourceOfAnnihilationMod.rl("compressed_chest_left"), "main");
    public static final ModelLayerLocation COMPRESSED_CHEST_RIGHT = new ModelLayerLocation(SourceOfAnnihilationMod.rl("compressed_chest_right"), "main");
