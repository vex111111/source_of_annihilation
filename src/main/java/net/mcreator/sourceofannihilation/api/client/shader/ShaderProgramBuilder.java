package net.mcreator.sourceofannihilation.api.client.shader;

import net.mcreator.sourceofannihilation.api.client.shader.ShaderObject.ShaderType;
import net.mcreator.sourceofannihilation.util.SneakyUtils;
...
import static net.mcreator.sourceofannihilation.util.SneakyUtils.nullCons;
