...
import net.mcreator.sourceofannihilation.util.java.ArrayUtils;
...
/**
 * Represents a Key for abstract data storage on an {@link net.mcreator.sourceofannihilation.api.client.render.pipeline.IVertexSource}
 *
 * @see net.mcreator.sourceofannihilation.api.client.render.pipeline.VertexAttribute
 * @see net.mcreator.sourceofannihilation.api.client.render.pipeline.IVertexSource#getAttribute
