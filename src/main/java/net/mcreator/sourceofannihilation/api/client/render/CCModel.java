package net.mcreator.sourceofannihilation.api.client.render;

import com.mojang.blaze3d.vertex.VertexFormat;
import net.mcreator.sourceofannihilation.api.client.render.lighting.LC;
import net.mcreator.sourceofannihilation.api.client.render.lighting.LightModel;
import net.mcreator.sourceofannihilation.api.client.render.model.ModelMaterial;
import net.mcreator.sourceofannihilation.api.client.render.pipeline.IVertexOperation;
import net.mcreator.sourceofannihilation.api.client.render.pipeline.IVertexSource;
import net.mcreator.sourceofannihilation.api.client.render.pipeline.attribute.*;
import net.mcreator.sourceofannihilation.api.client.render.pipeline.attribute.AttributeKey.AttributeKeyRegistry;
import net.mcreator.sourceofannihilation.util.client.VectorUtils;
import net.mcreator.sourceofannihilation.util.java.Copyable;
import net.mcreator.sourceofannihilation.util.vec.*;
import net.mcreator.sourceofannihilation.util.vec.uv.UV;
import net.mcreator.sourceofannihilation.util.vec.uv.UVTransformation;
import net.mcreator.sourceofannihilation.util.vec.uv.UVTranslation;
import org.jetbrains.annotations.Nullable;

import java.util.*;

import static net.mcreator.sourceofannihilation.util.SneakyUtils.unsafeCast;
import static net.mcreator.sourceofannihilation.util.vec.Rotation.sideRotations;
